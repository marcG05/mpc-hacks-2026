/* ============================================================
   Fraud Hunter — mock dataset
   Exposes window.FRAUD on the global scope.
   ============================================================ */
(function () {
  ...
  window.FRAUD = {
    SIGNAL_DEFS, FRAUD_TYPES, TX, LOG_SEED, BY_TYPE,
    // helpers
    sevOf(score) {
